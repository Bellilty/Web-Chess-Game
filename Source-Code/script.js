let main = {
    ...
    methods: {
        ...
        capture: function(target) {
            ...
            let capturedSymbol = main.variables.pieces[target.name].img;
            if (target.name.startsWith('w')) {
                $('#black-captured').append(capturedSymbol + ' ');
            } else {
                $('#white-captured').append(capturedSymbol + ' ');
            }
